<#import "templateRegister.ftl" as layout>
    <@layout.registrationLayout displayMessage=!messagesPerField.existsError('firstName','lastName','email','password','password-confirm'); section>
                    ...
                    <div class="${properties.kcFormGroupClass!} cds--text-input-wrapper">
                        ...
                        <div class="cds--input__field-outer-wrapper">
                            <div class="cds--text-input__field-wrapper" data-invalid="<#if messagesPerField.existsError('username','password')>true</#if>">
                                ...
                                <input
                                    placeholder="${msg("registerFirstNamePlaceholder")}"
                                    id="firstName"
                                    class="login-input-register
                                                            <#if messagesPerField.existsError('firstName')>cds--text-input--invalid input-error</#if>"
        ...
        <#if messagesPerField.existsError('firstName')>
            <span id="input-error-firstname" class="${properties.kcInputErrorMessageClass!} cds--form-requirement" aria-live="polite">
        ...
        <div class="${properties.kcFormGroupClass!} cds--text-input-wrapper">
            ...
            <div class="cds--input__field-outer-wrapper">
                <div class="cds--text-input__field-wrapper" data-invalid="<#if messagesPerField.existsError('username','password')>true</#if>">
                    ...
                    <input
                        placeholder="${msg("registerLastNamePlaceholder")}" id="lastName"
                        class="login-input-register
                                        <#if messagesPerField.existsError('lastName')>cds--text-input--invalid input-error</#if>"
                        name="lastName" value="${(register.formData.lastName!'')}" type="text" autofocus autocomplete="off"
                ...
                <#if messagesPerField.existsError('lastName')>
                    <span id="input-error-lastName" class="${properties.kcInputErrorMessageClass!} cds--form-requirement" aria-live="polite">
        ...
        <div class="${properties.kcFormGroupClass!} cds--text-input-wrapper">
            ...
            <div class="cds--input__field-outer-wrapper">
                <div class="cds--text-input__field-wrapper" data-invalid="<#if messagesPerField.existsError('username','password')>true</#if>">
                    ...
                    <input placeholder="${msg("loginEmailPlaceholder")}" id="email" class="login-input-register
                                <#if messagesPerField.existsError('email')>cds--text-input--invalid input-error</#if>"
                        name="email" value="${(register.formData.email!'')}" type="text" autofocus autocomplete="off"
                ...
                <#if messagesPerField.existsError('email')>
                    <span id="input-error-email" class="${properties.kcInputErrorMessageClass!} cds--form-requirement" aria-live="polite">
                ...
                <div class="cds--input__field-outer-wrapper">
                    <div class="cds--text-input__field-wrapper" data-invalid="<#if messagesPerField.existsError('username','password')>true</#if>">
                        ...
                        <input placeholder="${msg("loginPasswordPlaceholder")}" id="password" class="login-input-register
                                    <#if messagesPerField.existsError('password')>cds--text-input--invalid input-error</#if>"
                            name="password" value="${(register.formData.password!'')}" type="password" autofocus autocomplete="off"
        ...
        <div class="${properties.kcFormGroupClass!} cds--text-input-wrapper">
            ...
            <div class="cds--input__field-outer-wrapper">
                <div class="cds--text-input__field-wrapper" data-invalid="<#if messagesPerField.existsError('username','password')>true</#if>">
                    ...
                    <input placeholder="${msg("registerPasswordConfirmPlaceholder")}" id="password-confirm" class="login-input-register
                                <#if messagesPerField.existsError('password-confirm')>cds--text-input--invalid input-error</#if>"
                        name="password-confirm" value="${(register.formData.passwordConfirm!'')}" type="password" autofocus autocomplete="off"
                        aria-invalid="<#if messagesPerField.existsError('password-confirm')>true</#if>"
                        <#if messagesPerField.existsError('password-confirm')>data-invalid="true"
                    </#if>
                    />
                </div>
                <#if messagesPerField.existsError('password-confirm')>
        ...
        <div class="${properties.kcFormGroupClass!}">
            ...
            <div id="kc-form-buttons" class="${properties.kcFormButtonsClass!}">
                ...
                <button class="login-btn" name="register" id="kc-register" type="submit">
                    ${msg("doRegister")}
                </button>
            </div>
        </div>
