...
${msg("loginTitle",(realm.displayName!''))}
    ...
    <link rel="icon" href="${url.resourcesPath}/assets/icons/favicon.ico" />
...
<body class="${properties.kcBodyClass!}">
  ...
  <div class="${properties.kcLoginClass!} login-box">
    <div class="${properties.kcFormCardClass!} form-box-register">
        <header class="${properties.kcFormHeaderClass!} register-header">
