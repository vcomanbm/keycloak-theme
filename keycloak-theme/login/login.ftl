...
${properties.kcFormSocialAccountGridItem!}
                ...
                <#if p.iconClasses?has_content>
                  ...
                  <span class="${properties.kcFormSocialAccountNameClass!} kc-social-icon-text">Log in with ${p.displayName!}
                  </span>
                  <#else>
                    <span class="${properties.kcFormSocialAccountNameClass!}">Log in with ${p.displayName!}
                    </span>
                </#if>
              </a>
            </#list>
